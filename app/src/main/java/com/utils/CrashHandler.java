...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    // 用来显示Toast中的信息
    private static String error = "程序奔溃";
    //保存crash 异常文件路劲
...
// RuntimeException
        ...
        regexMap.put(".*ClassNotFoundException.*", "无法找到指定的类异常");
        regexMap.put(".*ArithmeticException.*", "运算条件异常");
        regexMap.put(".*ArrayIndexOutOfBoundsException.*", "数组超出异常");
        regexMap.put(".*IllegalArgumentException.*", "传递不合法参数异常");
        ...
        regexMap.put(".*OutOfMemoryError.*", "内存溢出异常");
        regexMap.put(".*StackOverflowError.*", "堆栈溢出错误");
