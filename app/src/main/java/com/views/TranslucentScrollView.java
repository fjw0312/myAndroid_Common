...
public class TranslucentScrollView extends ScrollView {
    ...
    /**
     * 使用demo:
     * 1.xml 布局   <TranslucentScrollView> 可拉动子view zoomView  <TranslucentScrollView/>
     * zoomView = findViewById(R.id.lay_header);    注意 整个页面要能滑动拉升到 可考虑TranslucentScrollView包住页面所以子view <包含多个子子view>
     * 2.获取控件
     * translucentScrollView = (TranslucentScrollView) findViewById(R.id.pullzoom_scrollview);
     //3.设置透明度变化监听
     translucentScrollView.setTranslucentChangedListener(new TranslucentChangedListener );
     //4.关联需要渐变的视图
